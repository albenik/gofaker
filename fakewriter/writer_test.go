...
func TestWriter_EOF(t *testing.T) {
	...
	assert.Equal(t, "write #1: unexpected [01]", tt.FailMessage)
}
...
func TestWriter_Locked(t *testing.T) {
	...
	assert.Equal(t, 1, n)
	assert.True(t, tt.FailedAsExpected)
	assert.Equal(t, "write #1: invalid data length: 101 expected but 1 recieved [01]", tt.FailMessage)

	n, err = w.Write([]byte{1})
	assert.NoError(t, err)
	assert.Equal(t, 0, n)
	assert.True(t, tt.FailedAsExpected)
	assert.Equal(t, "write #2: locked [01]", tt.FailMessage)
}
...
func TestAssertLen_MismatchNonzero(t *testing.T) {
	...
	assert.Equal(t, 2, n)
	assert.True(t, tt.FailedAsExpected)
	assert.Equal(t, "write #1: invalid data length: 3 expected but 2 recieved [01 02]", tt.FailMessage)
}
...
func TestAssertLen_MismatchZero(t *testing.T) {
	...
	assert.Equal(t, 0, n)
	assert.True(t, tt.FailedAsExpected)
	assert.Equal(t, "write #1: invalid data length: 3 expected but 0 recieved []", tt.FailMessage)
}
...
func TestAssertData_MismatchNonempty(t *testing.T) {
	...
	assert.Equal(t, 1, n)
	assert.True(t, tt.FailedAsExpected)
	assert.Equal(t, "write #1: invalid data: [01 02 03] expected but [01] recieved", tt.FailMessage)
}
...
func TestAssertData_MismatchEmpty(t *testing.T) {
	...
	assert.Equal(t, 0, n)
	assert.True(t, tt.FailedAsExpected)
	assert.Equal(t, "write #1: invalid data: [01 02 03] expected but [] recieved", tt.FailMessage)
}
...
func TestShortWrite_FailLen(t *testing.T) {
	...
	assert.Equal(t, 3, n)
	assert.True(t, tt.FailedAsExpected)
	assert.Equal(t, "write #1: invalid data length: 2 expected but 3 recieved [03 02 01]", tt.FailMessage)
}
...
func TestShortWrite_FailData(t *testing.T) {
	...
	assert.Equal(t, 3, n)
	assert.True(t, tt.FailedAsExpected)
	assert.Equal(t, "write #1: invalid data: [01 02 03] expected but [03 02 01] recieved", tt.FailMessage)
}
